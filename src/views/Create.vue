...
<script>
  ...
  export default {
    ...
    methods: {
      showConfirm(){
        const app = this
        if(app.asset.name !== "" && app.asset.symbol !== "" && app.supply > 0 && app.supply <= 1000000000000000){
          ...
          if(app.supply >= 1000000000000000){
            this.$buefy.toast.open({
              message: 'You can\'t issue more than 1Quadrillion token at time!',
              type: 'is-danger'
            })
          }
        }
